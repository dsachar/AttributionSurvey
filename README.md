...
3. **Interactive Task Screen**:
   ...
   - Requires the participant to rate each sentence on a 5-point Likert scale:
     - `+2` : **Strongly Helpful** (Crucial/necessary information to deduce the Answer)
     - `+1` : **Slightly Helpful** (Useful context or supporting info, but is not strictly necessary)
